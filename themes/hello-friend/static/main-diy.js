...
$(document).ready(function(){
  if ( $("#bber-talk").length > 0 ) {
    jsonUrl = "https://6368-chenplus-3gv70nip1e83c6e0-1253252860.tcb.qcloud.la/json/bber.json"
    $.getJSON(jsonUrl+"?t="+Date.parse( new Date()),function(res){
      ...
      $.each(res.data, function(i, item){
        ...
        bberHtml += '<li class="item item-'+(i+1)+'">'+dataTime+'： <a href="https://blog-chenplus.vercel.app/bb/">'+urlToLink(item.content)+'</a></li>'
      });
